...
{
   public class GetCategoriaWithProdutosQuery : Pagination, IRequest<IQueryResponse<CategoriaDTO>>
   {
        public class GetCategoriaWithProdutosQueryHandler : IRequestHandler<GetCategoriaWithProdutosQuery, IQueryResponse<CategoriaDTO>>
        {
            ...
            public async Task<IQueryResponse<CategoriaDTO>> Handle(GetCategoriaWithProdutosQuery request, CancellationToken cancellationToken)
            {
